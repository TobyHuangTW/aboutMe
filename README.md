...
### 作品集 
- <a href="https://toby-smoothies.firebaseapp.com/#/" target="_blank"><B>Toby Smoothies 思慕昔食譜網站</B> (RWD)</a> <BR>
  ? 使用 Firebase 的 Realtime database 抓取資料，透過 Vue.js 呈現在網頁上。 <BR>
  ? Vue-cli 架設 webpack 工作環境。 <BR>

- <a href="https://toby-chat.firebaseapp.com/" target="_blank"><B>Toby Chat 聊天平台</B> (RWD)</a> <BR>
  ? Firestore <BR>
  ? 使用 Vue.js + Firestore 實現即時更新聊天平台。<BR>
  ? 使用 Firebase Authentication 驗證使用者資訊。
  ? Vue-cli 架設 webpack 工作環境。 <BR>
   
- <a href="https://geo-toby.firebaseapp.com/" target="_blank"><B>Geo Toby 聊天牆</B> </a> <BR>
